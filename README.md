...
# Репозиторий с проектами онлайн-курса Яндекс.Практикум по специальности "Data Science Specialist" от 2021-2022 гг.

Здесь находятся проекты с выполнением задачи по анализу данных и машинному обучению с помощью SQL и Python.
